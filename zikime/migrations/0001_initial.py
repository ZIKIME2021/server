...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='device',
            name='serial',
            field=models.ForeignKey(db_column='Serial_ID', help_text='This value is automatically entered by reference.', on_delete=django.db.models.deletion.CASCADE, to='zikime.serial', verbose_name='시리얼 번호'),
        ),
        migrations.CreateModel(
            name='Attachment',
            fields=[
