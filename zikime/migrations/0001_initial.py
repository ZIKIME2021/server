    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(db_column='User_ID', help_text='This value must be entered by the owner or by the user specified by the owner.', on_delete=django.db.models.deletion.CASCADE, related_name='regist_user_id', to='zikime.customuser', verbose_name='디바이스에 연결된 사용자')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='device',
            name='serial',
            field=models.ForeignKey(db_column='Serial_ID', help_text='This value is automatically entered by reference.', on_delete=django.db.models.deletion.CASCADE, related_name='serial_id', to='zikime.serial', verbose_name='시리얼 번호'),
        ),
        migrations.CreateModel(
            name='Attachment',
            fields=[
